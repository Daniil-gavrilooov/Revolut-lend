$(document).ready(function () {
  ...
  function inetlStart() {
    ...
    for (var i = 0; i < inputs.length; i++) {
	  ...
	  var blackList = ["AZ","UA","RU","BY","GE","UZ","TJ","MD","RO","KZ"];
